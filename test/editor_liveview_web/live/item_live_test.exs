defmodule EditorLiveviewWeb.ItemLiveTest do
  use EditorLiveviewWeb.ConnCase
  ...
  describe "Index" do
    ...
    test "updates item in listing", %{conn: conn, item: item} do
      ...
      assert html =~ "some updated desc_string"
    end
